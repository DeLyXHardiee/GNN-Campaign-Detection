...
from seed_candidate_workflow.utils.pair_graph_contract import migrate_unscored_graph_id_column
...
def build_anchor_graph(config: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        out_base = (
            ...
            if out_base_raw
            else (project_root / "seed_candidate_workflow" / "output" / "graph_bundles" / graph_id / "anchor").resolve()
        )
