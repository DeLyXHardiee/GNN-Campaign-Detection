...
from seed_candidate_workflow.utils.community_eval_contract import evaluate_external_metrics
from seed_candidate_workflow.utils.semantic_shard_step3_helpers import best_sweep_metric_row
...
def test_run_graph_setup_shard_only_creates_only_shard_dirs(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "seed_candidate_workflow.pipelines.pipeline_helpers.graph_setup_pipeline._build_semantic_shard_pairgraph",
        _fake_build,
    )
