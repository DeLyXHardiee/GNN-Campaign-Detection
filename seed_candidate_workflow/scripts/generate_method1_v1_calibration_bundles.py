...
Usage (from repo root)::
    ...
    python seed_candidate_workflow/scripts/generate_method1_v1_calibration_bundles.py

Requires Step 2 graph artifacts under seed_candidate_workflow/output/semantic_shard_step2_graph/.
Writes to seed_candidate_workflow/output/semantic_shard_method1_diagnostics/method1_v1_calibration_runs/<variant_id>/.
"""
...
from seed_candidate_workflow.utils.method1_v1_calibration_variants import generate_all_v1_calibration_bundles
from seed_candidate_workflow.utils.semantic_shard_edge_refinement_method1 import Method1RefinementConfig
from seed_candidate_workflow.utils.semantic_shard_method1_diagnostics_helpers import load_method1_config_json
...
def main() -> None:
    ...
    p.add_argument(
        "--step2-dir",
        type=Path,
        default=PROJECT_ROOT / "seed_candidate_workflow" / "output" / "semantic_shard_step2_graph",
        help="Directory with Step 2 shard graph CSVs",
    )
    p.add_argument(
        "--method1-dir",
        type=Path,
        default=PROJECT_ROOT / "seed_candidate_workflow" / "output" / "semantic_shard_method1",
