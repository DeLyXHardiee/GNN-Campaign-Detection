...
Example:
  python seed_candidate_workflow/scripts/run_pu_threshold_retention_seed_candidate_workflow.py ^
...
from seed_candidate_workflow.utils.pu_threshold_retention_analysis import (  # noqa: E402
    DEFAULT_THRESHOLDS,
