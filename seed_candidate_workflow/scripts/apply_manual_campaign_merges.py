...
Usage:
  python seed_candidate_workflow/scripts/apply_manual_campaign_merges.py \\
    --gt data/groundtruth/ground_truth.json \\
    --merges seed_candidate_workflow/output/semantic_shard_oracle_headroom/manual_campaign_merges.json \\
...
from seed_candidate_workflow.utils.raw_gnn_notebook import parse_campaign_key
