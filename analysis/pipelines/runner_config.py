...
from analysis.utils.graph_scorer_registry import SCORER_REGISTRY, resolve_score_params
...
def build_run_context(
    *,
    ...
    mode = str(exp.get("mode") or "").strip().lower()
    graph_bundle_root = resolve_path(project_root, str(artifacts.get("graph_bundle_root") or "analysis/output/graph_bundles"))
    scoring_output_root = resolve_path(project_root, str(artifacts.get("scoring_output_root") or "analysis/output/scoring_runs"))
