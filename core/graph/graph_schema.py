...
DEFAULT_SCHEMA = GraphSchema(
    nodes={
        ...
        "html_structure_fingerprint": NodeMapping(
            canonical="html_structure_fingerprint",
            pyg="html_structure_fingerprint",
            memgraph="HtmlStructureFingerprint",
            memgraph_id_key="key",
            feature_strategy="str_len",
            extra_attr_keys=("docfreq",),
        ),
    ...
    edges={
        ...
        "has_email_domain": EdgeMapping(
            canonical="has_email_domain",
            src="email",
            rel_pyg="has_email_domain",
            dst="email_domain",
            memgraph_type="HAS_EMAIL_DOMAIN",
            memgraph_left_label="Email",
            memgraph_left_key="eid",
            memgraph_right_label="EmailDomain",
            memgraph_right_key="key",
            edge_strategy="email_to_email_domain",
        ),
        ...
        "has_html_structure_fingerprint": EdgeMapping(
            canonical="has_html_structure_fingerprint",
            src="email",
            rel_pyg="has_html_structure_fingerprint",
            dst="html_structure_fingerprint",
            memgraph_type="HAS_HTML_STRUCTURE_FINGERPRINT",
            memgraph_left_label="Email",
            memgraph_left_key="eid",
            memgraph_right_label="HtmlStructureFingerprint",
            memgraph_right_key="key",
            edge_strategy="email_to_entity",
        ),
        ...
        "has_helo_host": EdgeMapping(
            canonical="has_helo_host",
            src="email",
            rel_pyg="has_helo_host",
            dst="helo_host",
            memgraph_type="HAS_HELO_HOST",
            memgraph_left_label="Email",
            memgraph_left_key="eid",
            memgraph_right_label="HeloHost",
            memgraph_right_key="key",
            edge_strategy="email_to_entity",
        ),
